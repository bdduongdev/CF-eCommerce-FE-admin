          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-end gap-3 pt-6 border-t">
              ...
              <button
                type="submit"
                disabled={updateProductMutation.isPending}
                className={`px-4 py-2 rounded-lg text-sm font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ${updateProductMutation.isPending
